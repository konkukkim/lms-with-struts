...
public class ReportContentsDTO {
    ...
    public String toString() {
        return  "systemCode="+systemCode+",curriCode="+curriCode+",curriYear="+curriYear+",curriTerm="+curriTerm+",courseId="+courseId
               +",reportId="+reportId+",reportNo="+reportNo+",reportType="+reportType+",contents="+contents+",reportple1="+reportple1
               +",reportple2="+reportple2+",reportple3="+reportple3+",reportple4="+reportple4+",reportple5="+reportple5+",answer="+answer
