 ...
 * @since       2004. 9. 13.
 */
public class ReportBankInfoDTO {

    protected String systemCode="";
    protected String courseId="";
    protected int reportBankId=0;
    protected String reportBankName="";
    ...
    public void setReportBankName(String reportBankName) {
        this.reportBankName = reportBankName;
    }
    ...
    public String toString() {
        return  "systemCode="+systemCode+",courseId="+courseId+",reportBankId="+reportBankId+",reportBankName="+reportBankName+",regId="+regId
