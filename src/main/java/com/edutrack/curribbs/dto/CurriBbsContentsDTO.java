 ...
 * @since       2004. 9. 13.
 */
public class CurriBbsContentsDTO {
    ...
    public String toString() {
        return  "systemCode="+systemCode+",curriCode="+curriCode+",curriYear="+curriYear+",curriTerm="+curriTerm+",bbsType="+bbsType
               +",seqNo="+seqNo+",courseId="+courseId+",bbsNo="+bbsNo+",depthNo="+depthNo+",orderNo="+orderNo
               +",parNo="+parNo+",contentsType="+contentsType+",editorType="+editorType+",subject="+subject+",keyword="+keyword
               +",contents="+contents+",rfileName1="+rfileName1+",sfileName1="+sfileName1+",filePath1="+filePath1+",fileSize1="+fileSize1
               +",rfileName2="+rfileName2+",sfileName2="+sfileName2+",filePath2="+filePath2+",fileSize2="+fileSize2+",rfileName3="+rfileName3
               +",sfileName3="+sfileName3+",filePath3="+filePath3+",fileSize3="+fileSize3+",hitNo="+hitNo+",regId="+regId
               +",regName="+regName+",regDate="+regDate+",modId="+modId+",modDate="+modDate;
    }
