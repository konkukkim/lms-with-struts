...
public class ExamContentsDTO {
	 ...
	 */
	public void setOldSfile(String oldFile) {
		this.oldSfile = oldFile;
	}
    ...
    public String toString() {
        return  "systemCode="+systemCode+",curriCode="+curriCode+",curriYear="+curriYear+",curriTerm="+curriTerm+",courseId="+courseId
               +",examId="+examId+",examNo="+examNo+",examType="+examType+",contents="+contents+",example1="+example1
               +",example2="+example2+",example3="+example3+",example4="+example4+",example5="+example5+",answer="+answer
               +",xcomment="+comment+",score="+score+",rfileName="+rfileName+",sfileName="+sfileName+",filePath="+filePath
               +",fileSize="+fileSize+",regId="+regId+",regDate="+regDate+",modId="+modId+",modDate="+modDate;
    }
