 ...
 * @since       2004. 9. 13.
 */
public class ExamBkContentsDTO {

    protected String systemCode="";
    protected String courseId="";
    protected long examBkCode=0;
     ...
     * @param       examBkCode
     */
    public void setExamBkCode(long examBkCode) {
    ...
    public String toString() {
        return  "systemCode="+systemCode+",courseId="+courseId+",examBkCode="+examBkCode+",examNo="+examNo+",examType="+examType
               +",contents="+contents+",example1="+example1+",example2="+example2+",example3="+example3+",example4="+example4
               +",example5="+example5+",answer="+answer+",xcomment="+comment+",rfileName="+rfileName+",sfileName="+sfileName
