 ...
 * @since       2004. 9. 13.
 */
public class CurriTopCourseDTO {
    ...
    public String toString() {
        return  "systemCode="+systemCode+",curriCode="+curriCode+",courseId="+courseId+",courseType="+courseType+",profId="+profId
               +",examBase="+examBase+",reportBase="+reportBase+",attendBase="+attendBase+",concernBase="+concernBase+",forumBase="+forumBase
               +",etc1Base="+etc1Base+",etc2Base="+etc2Base+",regId="+regId+",regDate="+regDate+",modId="+modId
               +",modDate="+modDate;
    }
