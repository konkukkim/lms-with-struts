...
public class SelectStatement extends QueryStatement 
{
	...
	public String getSql()
	{
		...
		if (StringUtil.isNotNull(where)) s.append("\n").append(WHERE).append(where);
		if (StringUtil.isNotNull(groupby)) s.append("\n").append(GROUP_BY).append(groupby);
		if (StringUtil.isNotNull(having)) s.append("\n").append(HAVING).append(having);
		if (StringUtil.isNotNull(orderby)) s.append("\n").append(ORDER_BY).append(orderby);
