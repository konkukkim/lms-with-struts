...
public class CurriQuizDTO {
    ...
    public String toString() {
        return  "systemCode="+systemCode+",curriCode="+curriCode+",curriYear="+curriYear+",curriTerm="+curriTerm+",courseId="+courseId+",contentsId="+contentsId+",quizOrder="+quizOrder+",quizType="+quizType
