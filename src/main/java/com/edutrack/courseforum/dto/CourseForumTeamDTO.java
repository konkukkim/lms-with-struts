 ...
 * @since       2004. 9. 13.
 */
public class CourseForumTeamDTO {
    ...
    public String toString() {
        return  "systemCode="+systemCode+",curriCode="+curriCode+",curriYear="+curriYear+",curriTerm="+curriTerm+",courseId="+courseId
               +",forumId="+forumId+",userId="+userId+",subTeamNo="+subTeamNo+",score="+score+",connectNo="+connectNo
	...
	/**
	 * @return Returns the subTeamNo.
	 */
	public int getSubTeamNo() {
		return subTeamNo;
	}
	/**
	 * @param subTeamNo The subTeamNo to set.
	 */
