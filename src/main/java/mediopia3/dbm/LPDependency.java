...
public class LPDependency {
  ...
  public void setAttribute(String name, String val) {
      if (name.equalsIgnoreCase("identifierref")) this.identifierref = val;
...
//##############################################################################
  ...
  public String getStrSchema() {
    return "id, nodeID, identifierref";
  }
  public String getAllField() {
    return "('" + id + "', '" + nodeID + "', '" + rmvQuatMark(identifierref) + "')";
  }
