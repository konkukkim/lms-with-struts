...
/**
 *  폼의 checkbox 를 token 한다.
 *
 * @param    form.selectBox 명
 */
var objChecked = false;
function setAllToken(obj) {
    var objLen = 0;
	obj = document.querySelectorAll("input[type='checkbox']"); // ADD 2021-12-02
