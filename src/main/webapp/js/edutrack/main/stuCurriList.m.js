...
//alert('============ gubun01 : check01');
					...
					// 2012-11
					// FAIL
					//var lectureLink = CONTEXTPATH+"/CurriContents.cmd?cmd=lecContentsList&MENUNO=0&pMode=Lecture&pCourseId=&pCourseName=&pCurriCode="+ curriCode +"&pCurriYear="+ curriYear +"&pCurriTerm="+ curriTerm +"&pCurriType="+curriType+"&pCurriName="+curriName;
		       			 var lectureLink = CONTEXTPATH+"/LectureMain.cmd?cmd=goLecture&pMode=Lecture&MENUNO=0&pMobile=Y&pCurriCode="+ curriCode +"&pCurriYear="+ curriYear +"&pCurriTerm="+ curriTerm +"&pCurriType="+curriType+"&pCurriName="+curriName;
