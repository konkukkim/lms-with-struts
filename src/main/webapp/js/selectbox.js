...
SS_ENV.CR.Border = '#E2E0D4';

SS_ENV.CR.BorderActive = '#E2E0D4';

SS_ENV.ImgPrefix = '../main/image/';

SS_ENV.DefaultHeight =10;
...
SS_ENV.OptionsDivStyle = ''
  ...
  + ' scrollbar-face-color:#F8F6E7;'

  + ' scrollbar-shadow-color:F8F6E7;'

  + ' scrollbar-highlight-color:#F8F6E7;'

  + ' scrollbar-3dlight-color:F8F6E7;'

  + ' scrollbar-darkshadow-color:#F8F6E7;'

  + ' scrollbar-track-color:#FFFFF7;'

  + ' scrollbar-arrow-color:#AEA38B;';
...

{
  ...
  this.TitleTable.cells(1).innerHTML = "<img src='../main/image/user_bt.gif' border=0 align=absmiddle>";

  this.TitleTable.cells(2).innerHTML = "<img src='../main/image/user_bt.gif' border=0 align=absmiddle>";
