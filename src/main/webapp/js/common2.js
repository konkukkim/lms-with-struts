 ...
 **********************************************************************************************/
    ...
    function emailCheck(emailStr) {
        ...
        if (matchArray==null) {
            alert("wrong email addresss (check @ and .'s)");
            return false;
        }
        ...
        for (i=0;i<len;i++) {
            if (domArr[i].search(atomPat)==-1) {
                alert("not exits domainname.");
                return false;
            }
        }
        if (checkTLD && domArr[domArr.length-1].length!=2 && 
            domArr[domArr.length-1].search(knownDomsPat)==-1) {
            alert("unknown type." + "country.");
            return false;
        }
        if (len<2) {
