...
//            return true;
	...
	function goCommDel(poll_id, seq_no) {
		...
		if (stat == true) {
			document.location = "<%=CONTEXTPATH%>/Poll.cmd?cmd=pollCommentDelete&pGubun=MAIN&pMode=<%=PMODE%>&pPollId="+poll_id+"&pSeqNo="+seq_no;
		}
	}
	...
	<table width="100%" height="100%" border="0">
		<tr>
			...
			<td class="pop_topbg"><img src="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/common/blet05.gif" align="absmiddle"><font class="pop_tit">온라인투표</font></td>
					...
					<tr height="97%">
						<td align="left" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td class="s_tab_view01" width="40">제목</td>
									<td class="s_tab_view03"><%=pollView.getSubject()%><font color="#3399FF"> (응답인원 :&nbsp;<%=tot_cnt%>명)</font></td>
								</tr>
								<tr class="s_tab03">
									<td colspan="2"></td>
								</tr>
								<tr>
									...
									<td class="s_tab_view03"><%=StringUtil.getHtmlContents(pollView.getContents())%></td>
								</tr>
								<tr class="s_tab03">
									<td colspan="2"></td>
								</tr>
											...
											<tr>
												<td width="260" height="17">
													<table height=17 cellspacing=1 cellpadding=1 bgcolor=#f4f4f4>
														<tr>
															<td width=230 bgcolor=#ffffff height=17>
																<table height="17" width="230" align="center">
																	<tr>
												...
												<td ><b><font class="s_text03"><%=pollView.getHit()[i]%></font></b>표</td>
												<td >&nbsp;&nbsp;<font class="s_text03"><%=pcnt%></font>%</td>
											</tr>
										</table>
<%
	}
...
<form name=Input method="post" action="<%=CONTEXTPATH%>/Poll.cmd?cmd=pollCommentRegist&pGubun=MAIN">
...
<%		}	%>
											...
											<tr>
												<td class="reply_w_text01">
													<textarea name="pContents" rows=2 wrap=virtual cols=50 maxlength='4000' dispName="답변내용" lenCheck="2000" notnull></textarea>
...
%>
															...
															<td width=""><font color=#9a7441><%=poll.getRegName()%></font></td>
															<td>
																<%=StringUtil.getHtmlContents(poll.getContents())%>
																&nbsp;<img src="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/bbs/icon_reply.gif" align="absmiddle">&nbsp;
															</td>
															<td width="" align="right" style="padding-right:6px"><%=DateTimeUtil.getDateType(1, poll.getRegDate())%></td>
