...
%>
										<table width="670" align="center">
											...
											<tr>
												<td class="s_tab_view01" width="120">첨부파일</td>
												<td class="s_tab_view03" colspan="3">
<%	if(!rfileName3.equals("") && !rfileName3.equals("null")) { %>
<a href="javascript:fileDownload('<%=rfileName3%>','<%=sfileName3%>','<%=filePath3%>','<%=fileSize3%>');"><img
src="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/common/ico_file.gif" border="0" align="absmiddle"> <%=rfileName3%></a>
<%	} %>
												</td>
											</tr>
											<tr class="s_tab05">
...
<%	if (pMODE.equals("EDIT") && pEndYn.equals("Y") && pMarkCheckYn.equals("")) {	%>
