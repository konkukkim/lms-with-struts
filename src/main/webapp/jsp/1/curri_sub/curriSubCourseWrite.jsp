...
<%@ page import ="com.edutrack.curritop.dto.CurriTopCourseDTO,com.edutrack.common.dto.CodeParam"%>
...
<form name=Input method="post" action="<%=CONTEXTPATH%>/CurriSubCourse.cmd?cmd=curriSubCourseRegist&pRegMode=Add">
...
<input type=hidden name=pCourseType value="<%=model.get("courseType")%>">
	<table width="100%" height="100%" border="0">
		<tr>
			<td class="pop_topleft"></td>
			<td class="pop_topbg"><img src="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/common/blet05.gif" align="absmiddle"><font class="pop_tit">과목연결정보 입력</font></td>
						...
						<td align="left" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="s_tab_view02"><font class="c_text02"><b><%=model.get("curriName")%></b></font></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="s_tab_view02"><%=model.get("courseName")%></td>
								</tr>
								<tr>
									<td height="1" colspan="4" class="c_test_tablien01"> </td>
								</tr>
...
%>
								...
								<tr>
									...
									<td class="s_tab_view02"><input type="text" name=pExamBase size=3 maxlength=3 value="30" class="sky">%</td-->
									<input type="hidden" name=pExamBase size=3 maxlength=3 value="0" class="sky">
									<td class="s_tab_view01">출석기준비율</td>
									<td class="s_tab_view02" colspan=3><input type="text" name=pAttendBase size=3 maxlength=3 value="30" class="sky" >%</td>
								</tr>
								<tr>
									<td height="1" colspan="4" class="c_test_tablien01"> </td>
								</tr>
								<tr>
									...
									<td class="s_tab_view02"><input type="text" name=pReportBase size=3 maxlength=3 value="30" class="sky">%</td>
									<td class="s_tab_view01">포럼기준비율</td>
									<td class="s_tab_view02"><input type="text" name=pForumBase size=3 maxlength=3 value="10" class="sky" >%</td>
								</tr>
								<tr>
									<td height="1" colspan="4" class="c_test_tablien01"> </td>
								</tr>
								<tr>
									...
									<td class="s_tab_view02"><input type="text" name=pEtc1Base size=3 maxlength=3 value="30" class="sky" >%</td>
									<td class="s_tab_view01">기타기준비율</td>
									<td class="s_tab_view02"><input type="text"name=pEtc2Base size=3 maxlength=3 value="0" class="sky" >%</td>
								</tr>
