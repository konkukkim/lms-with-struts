	...
	function joinCommunity(commId){
		if(confirm('동아리 가입하시겠습니까?\n\n가입시 나의 동아리 메뉴로 이동합니다.')){
			document.location = "Community.cmd?cmd=joinCommunity&pCommId=" + commId + "&MENUNO=0";
								...
								<tr valign="top">
									<!-- community title -->
									<td height="34" width="346" class="com_stit_title" valign="bottom"><img src="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/community/com_centitile.gif" width="14" height="17" align="absmiddle">&nbsp;<font face='돋움' size="3"><b>추천 동아리</b></font></td>
									<!-- // community title -->
									<!-- history -->
