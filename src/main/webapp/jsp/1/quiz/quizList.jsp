...
<% 	String pCourseId = (String)model.get("pCourseId");
	...
	String pQuizCount = (String)model.get("pQuizCount");
	String pQuizPoint = (String)model.get("pQuizPoint");
%>
<script type="text/javascript" src="<%=CONTEXTPATH%>/dwr/interface/QuizWork.js"></script>
<script type="text/javascript" src="<%=CONTEXTPATH%>/js/edutrack/course/quizList.js"></script>
										<!-- 내용 -->
										<!-- 게시판 리스트 시작 -->
										<table width="670" align="center">
<form name='Input'>
											<tr>
												<td colspan="5" class="s_btn01">
...
<%		} %>
											<tr onMouseOver="this.className='tab_over'" onMouseOut="this.className='tab_out'">
												...
												<td></td>
												<td class="s_tab04"><a href="<%=CONTEXTPATH%>/Quiz.cmd?cmd=quizEdit&pCourseId=<%=pCourseId%>&pContentsId=<%=pContentsId%>&pQuizOrder=<%=list.getInt("quiz_order")%>"><%=StringUtil.setMaxLength(StringUtil.nvl(list.getString("contents_text")),60)%></a></td>
												<td></td>
