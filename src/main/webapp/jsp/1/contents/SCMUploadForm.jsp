...
<%
	...
	String Action = CONTEXTPATH+"/Contents.cmd?cmd=SCMUpload&pCourseId="+pCourseId+"&pUploadMode=MOD";
	if(pContentsCnt > 0)
		Action = CONTEXTPATH+"/Contents.cmd?cmd=SCMUpload&pCourseId="+pCourseId+"&pUploadMode=ADD";
%>
<script language=javascript>
    ...
    function change_upload_mode(frm,mode){
    	frm.action="<%=CONTEXTPATH%>/Contents.cmd?cmd=SCMUpload&pCourseId=<%=pCourseId%>&pUploadMode="+mode;
    }
</script>
