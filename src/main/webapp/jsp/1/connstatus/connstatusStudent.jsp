...
<%@ page import ="javax.sql.RowSet,com.edutrack.framework.util.StringUtil,com.edutrack.framework.util.DateTimeUtil"%> 
<%@ page import ="com.edutrack.connstatus.dto.SystemConnectDTO,com.edutrack.connstatus.dto.ConnectResDTO,java.text.DecimalFormat"%> 

<%  SystemConnectDTO systemConnectDto = (SystemConnectDTO)model.get("systemConnectDto"); 
    ArrayList list = (ArrayList)model.get("studentConCntList"); 
	double totalCnt = 0.0;

  	int year = Integer.parseInt(DateTimeUtil.getYear());		//현재 년
	int mon = Integer.parseInt(DateTimeUtil.getMonth());		//현재 월
	
    String studentGb = systemConnectDto.getStudentGb();	
                ...
                <tr>
					<td height="410" align="left" valign="top" style="padding:0 10 0 15">	
           				<table width="100%" height="35" border="0" cellpadding="0" cellspacing="0" background="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/myeda/03_cen_titlebg.gif">
							<tr>
								<td align="left" valign="middle" style="padding:0 0 0 8"><img src="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/myeda/03_title31.gif" width="134" height="19"></td>
							</tr>
						</table>
						...
						<!-- form start -->
						<form name="myform" method="post" action="<%=CONTEXTPATH%>/ConnStatus.cmd?cmd=studentStatusAction">
							<tr>
...
<%
    ...
    for(int i=0;i<list.size();i++){
        tmpResult = (String[])list.get(i);
        totalCnt +=  Integer.parseInt(tmpResult[1]);
    }
																				...
																				<tr>
																					<td width="100%" height="10" bgcolor="white">
																						<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" height="8">
																							<tr>
																								<td>
																									<img src="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/common/ing_bar.gif" width="<%=barWidth%>" height="13" hspace="2" align="abdmiddle">
																								</td>
																							</tr>
																						</table>
																					</td>
...
%>
											...
											<tr>
												...
												<b>전체 : <font color="#FF6600"><%=(int)totalCnt%></font> 명</b>
												</td>
											</tr>
											<tr>
