...
<%@ page import ="java.text.DecimalFormat,com.edutrack.connstatus.dto.CurriConnectDTO,java.text.DecimalFormat"%>

<% 	ArrayList resultList = (ArrayList)model.get("curriConCntList");
 	CurriConnectDTO curriConnectDto = (CurriConnectDTO)model.get("curriConnectDto");
	...
	String selectGb = curriConnectDto.getSelectGb();
	String startYear = curriConnectDto.getStartYear();
	String startMon = curriConnectDto.getStartMon();
	String startDay = curriConnectDto.getStartDay();
	String endYear = curriConnectDto.getEndYear();
	String endMon = curriConnectDto.getEndMon();
	String endDay = curriConnectDto.getEndDay();
...
<input type=hidden name="cmd" value="curriConnAction">	
<input type=hidden name="MENUNO" value="5">	
											<tr class="s_tab01">
												<td colspan="2"></td>
											</tr>
											<tr>
												<td class="s_tab_view01" width="92">날짜선택</td>
...
%>
											...
											<tr>
												<td class="s_tab_view01">구분선택</td>
												<td class="s_tab_view02">
													<%=model.get("cateSelect")%>
													<%=model.get("codeSelect")%>
													<%=model.get("curriSelect")%>
													...
													<img src="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/button_img/btn_search.gif" align="absmiddle" border="0" onClick="fnSelectGb();" style="cursor:hand;">
												</td>
											</tr>
											<tr class="s_tab05">
												<td colspan="2"></td>
