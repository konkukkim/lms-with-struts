...
<form name=Input method="post" action="<%=CONTEXTPATH%>/CurriTopCourse.cmd?cmd=curriTopCourseRegist&pRegMode=Edit">
...
<input type="hidden" name="pCourseType" value="<%=model.get("pCourseType")%>">
	<table width="100%" height="100%" border="0">
		<tr>
			...
			<td class="pop_topbg"><img src="<%=CONTEXTPATH%>/img/<%=SYSTEMCODE%>/common/blet05.gif" align="absmiddle"><font class="pop_tit">과목 연결정보 수정</font></td>
						...
						<td align="left" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="s_tab_view02"><font class="c_text02"><b><%=model.get("pCurriName")%></b></font></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="s_tab_view02"><%=model.get("pCourseName")%></td>
								</tr>
								<tr>
									<td height="1" colspan="4" class="c_test_tablien01"> </td>
								</tr>
...
%>
								...
								<tr>
									...
									<td class="s_tab_view02" colspan="3"><input type="text" name=pAttendBase size=3 maxlength=3 value="<%=model.get("pAttendBase")%>" class="sky" >%</td>
								</tr>
								<tr>
									<td height="1" colspan="4" class="c_test_tablien01"> </td>
								</tr>
								<tr>
									...
									<td class="s_tab_view02"><input type="text" name=pReportBase size=3 maxlength=3 value="<%=model.get("pReportBase")%>" class="sky">%</td>
									<td class="s_tab_view01">포럼기준비율</td>
									<td class="s_tab_view02"><input type="text" name=pForumBase size=3 maxlength=3 value="<%=model.get("pForumBase")%>" class="sky" >%</td>
								</tr>
								<tr>
									<td height="1" colspan="4" class="c_test_tablien01"> </td>
								</tr>
								<tr>
									...
									<td class="s_tab_view02"><input type="text" name=pEtc1Base size=3 maxlength=3 value="<%=model.get("pEtc1Base")%>" class="sky" >%</td>
									<td class="s_tab_view01">기타기준비율</td>
									<td class="s_tab_view02"><input type="text"name=pEtc2Base size=3 maxlength=3 value="<%=model.get("pEtc2Base")%>" class="sky" >%</td>
								</tr>
