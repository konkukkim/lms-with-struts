...
<script type="text/javascript" src="<%=CONTEXTPATH%>/js/edutrack/course_exam/examBankContents.js"></script>
										...
										<table width="670" align="center">
											...
											<tr>
												...
												<td class="s_tab_view03">
													<textarea name="pContents" cols="90" rows="10" wrap="VIRTUAL"><%=contentsInfo.getContents()%></textarea>
...
%>
													<input type="file"   name="pFile" size="45" class=brown>
												</td>
											</tr>
											<tr class="s_tab03">
												<td colspan="2"></td>
