...
%>
<script type="text/javascript" src="<%=CONTEXTPATH%>/dwr/interface/ExamResultWork.js"></script>
...
<%
	if(COURSELISTSIZE > 1) {
		CodeParam param = new CodeParam();
   		...
   		param.setEvent("profResultAutoReload()");
...
%>
											...
											<tr>
												<td colspan="11">
													<!-- 리스트 -->
													<div id="examResultListDiv" style="width:100%;display:none"></div>
													<!-- 리스트 -->
												</td>
											</tr>
											<tr class="s_tab05">
...
<script language="javascript">
	resultInit('<%=CONTEXTPATH%>','<%=COURSELISTSIZE%>','<%=pCourseId%>','PROF');
</script>
