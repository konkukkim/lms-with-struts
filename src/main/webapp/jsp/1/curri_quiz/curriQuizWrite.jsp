...
<script language="javascript">
	function goList(){
		document.location.href="<%=CONTEXTPATH%>/CurriQuiz.cmd?cmd=curriQuizList&pCurriCode=<%=pCurriCode%>&pCurriYear=<%=pCurriYear%>&pCurriTerm=<%=pCurriTerm%>&pCourseId=<%=pCourseId%>&pContentsId=<%=pContentsId%>";
	}
...
<form method="post" name="Input" action = "<%=CONTEXTPATH%>/CurriQuiz.cmd?cmd=curriQuizRegist&pRegMode=ADD&pCurriCode=<%=pCurriCode%>&pCurriYear=<%=pCurriYear%>&pCurriTerm=<%=pCurriTerm%>&pCourseId=<%=pCourseId%>&pContentsId=<%=pContentsId%>"  enctype="multipart/form-data">
