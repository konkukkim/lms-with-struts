...
<%@ page import ="javax.sql.RowSet,com.edutrack.currisub.dto.CurriQuizDTO,com.edutrack.common.dto.EditorParam"%>
...
<% 	String pCurriCode = (String)model.get("pCurriCode");
	...
	CurriQuizDTO quizDto= (CurriQuizDTO)model.get("quizDto");
...
<script type="text/javascript" src="<%=CONTEXTPATH%>/js/edutrack/curri_sub/curriQuizEdit.js"></script>
...
<textarea name="pContents" rows=9 cols=77><%=StringUtil.nvl(quizDto.getContents())%></textarea>
<%
...
<!-- 페이지초기화 -->
<script language="javascript">init('<%=SYSTEMCODE%>','<%=CONTEXTPATH%>','<%=pQuizType%>');</script>
