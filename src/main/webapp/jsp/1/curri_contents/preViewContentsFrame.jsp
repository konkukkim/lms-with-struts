...
<%}%>
	<frameset rows="0,*" frameborder=0 border=0 framespacing=0>
		...
		<frame name="contents_show" src = "<%=CONTEXTPATH%>/CurriContents.cmd?cmd=preViewContentsShow&pCourseId=<%=model.get("pCourseId")%>&pContentsId=<%=model.get("pContentsId")%>" scrolling=auto marginwidth=0 marginheight=0>
	</frameset>
</html>
