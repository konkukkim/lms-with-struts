...
<%@include file="../common/course_header.m.jsp" %>
<%
...
-->
<script type="text/javascript" src="<%=CONTEXTPATH%>/js/edutrack/curri_sub/lecContents.m.js"></script>
...
<!-- This <tr> is coded at jsp/1/curri_contents/lecContentsList.m.jsp -->
											<tr class="s_tab02">
												<td width="40">번호</td>
...
<!-----------------------------------------------------------------------------------  2018-04 BLOCK
												...
												<td class="s_tablien"></td>
-------------------------------------------------------------------------------------------------->
												<td width="45">접속<br>횟수</td> <!-- 2018-04 Visible -->
<!-----------------------------------------------------------------------------------  2012-11 BLOCK
...
<%@include file="../common/course_footer.m.jsp" %>
