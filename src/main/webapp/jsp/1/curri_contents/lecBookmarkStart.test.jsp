...
<%@ page import ="com.edutrack.currisub.*"%> 
<%
    Map model = (Map)request.getAttribute("MODEL");
%>
<script type="text/javascript" src="http://www.junnodae.org/dwr/interface/CurriContentsWork.js"></script>
<script type="text/javascript" src="http://www.junnodae.org/dwr/engine.js"></script>
<script type="text/javascript" src="http://www.junnodae.org/dwr/util.js"></script>
<script language=javascript src="/js/flash.js"></script>
<Script Language=JavaScript src="/js/common1.js"></script>
<script language=javascript src="/js/common_util.js"></script>
<script language=javascript src="/js/common_button.js"></script>
<script language=javascript src="/js/imagesover.js"></script>
...
<script type="text/javascript" src="/js/util/imageView.js"></script>
<script type="text/javascript" src="/dwr/interface/CommonUtilWork.js"></script>
		    	...
		    	if(contentsType !="C" || serverPath != ""){
		    		...
		    		if(parseFloat(cStartDate) <= parseFloat(curDate) && cLectureGubun == "1") {
				  		if(contentsType =="C" && serverPath == ""){
				  			...
				  			lecLink = "<a href=\"javascript:goContents('"+COURSE_ID+"','"+contentsId+"',"+viewWidth+","+viewHeight+")\">"+contentsName.substring(0, 15)+"</a>";
				  		}
		    		}
		    			...
		    			lecLink = "<a href=\"javascript:alert('아직 수강기간이 시작되지 않았습니다.')\">"+contentsName.substring(0, 17);
		    		}
					...
					// 4. 단원평가가 있을 경우 통과(P)해야 한다.
		  			...
		  			if(prevContentsView == "N" && CLASS_USER_TYPE != "P")
						lecLink = "<a href=\"javascript:alert('이전 강의를 수강 하셔야 합니다.')\">"+contentsName.substring(0, 17)+"</a>";
					if(prevQuizPass != "P" && CLASS_USER_TYPE != "P" && QUIZ_CONFIG_YN == "Y")
						lecLink = "<a href=\"javascript:alert('이전  단원평가를 통과 하셔야 합니다.')\">"+contentsName.substring(0, 17)+"</a>";
...
<script language="javascript">
	bookmarkEnd('1101021','20140106152603000003','20140116144601');
</script>
654:w
321111111111111
</head>
