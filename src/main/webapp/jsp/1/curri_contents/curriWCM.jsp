...
<%@include file="../contents/WCM_header.jsp" %>
<%
...
<form name='WCM' method='post' action="<%=CONTEXTPATH%>/CurriContents.cmd?cmd=curriContentsRegist" onSubmit="return chkForm(this)">
